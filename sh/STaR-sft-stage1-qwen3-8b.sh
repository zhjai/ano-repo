...
project_name='STaR'
exp_name='STaR-Qwen3-8B-SFT-Stage1'
home_dir='STaR'
mkdir -p "$home_dir/log/$project_name/$exp_name"
save_path="$home_dir/checkpoints/$project_name/$exp_name"
mkdir -p $save_path

MODEL_PATH="$home_dir/checkpoints/STaR/STaR-Qwen3-8B-SFT-Stage1/global_step_273"
TRAIN_FILE="$home_dir/data/final/table-r1-tqa-train-easy.parquet"
TEST_FILE="$home_dir/data/final/table-r1-tqa-test.parquet"
